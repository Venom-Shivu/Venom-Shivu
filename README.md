...
I build **end-to-end analytical systems** — not just dashboards.

My work focuses on designing scalable data workflows that move from:

Raw Data → Structured Models → Business Metrics → Predictive Insight → Executive Reporting

I prioritize:

- Clarity over complexity  
- Performance over shortcuts  
- Architecture over isolated scripts  
...
![Power Pivot](https://img.shields.io/badge/Power%20Pivot-Modeling-0078D4?style=for-the-badge)
![DAX](https://img.shields.io/badge/DAX-Analytics-red?style=for-the-badge)
...
**Python • Excel Power Pivot • DAX • KPI Design**
